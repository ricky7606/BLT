...
function chkMobile(){
	...
	if(mobile.length > 0){
		if(chkCellphone()){
			$.post('/mobile/register/chkMobile', {mobile:mobile}, function(msg) {
				if(msg=='exists'){
...
function submitForm(){
	...
	$.post('/mobile/userprofile/saveDetails', {mobile:jQuery.trim($('#old_mobile').val()),gender:jQuery.trim($('#gender').val()),brief:clearString(jQuery.trim($('#brief').val())),email:jQuery.trim($('#email').val()),location:clearString(jQuery.trim($('#location').val())),industry:clearString(jQuery.trim($('#industry').val())),career:clearString(jQuery.trim($('#career').val())),education:clearString(jQuery.trim($('#education').val())),introduction:clearString(jQuery.trim($('#introduction').val()))}, function(msg) {
		if(msg=='ok'){
...
function changeUsername(){
	if(isUsernameOK){
		...
		$.post('/mobile/userprofile/changeUsername', {username:jQuery.trim($('#username').val())}, function(msg) {
			if(msg=='ok'){
...
function changePassword(){
	if(isPasswordOK && isPassword2OK){
		...
		$.post('/mobile/userprofile/changePassword', {password:jQuery.trim($('#password').val()),new_password:jQuery.trim($('#new_password').val()),mobile:jQuery.trim($('#old_mobile').val())}, function(msg) {
			if(msg=='ok'){
