...
function searchTags(new_page){
	...
	$.post('/mobile/usertags/searchTags', {tag:jQuery.trim($('#search_tags').val()),page:new_page}, function(msg) {
		if(msg == ''){
			...
			if(no_searched == '1'){
				$("#root_tags").css('display','none');
				tmpStr = "<div id=\"search_result\" style=\"display: block\"><span class=\"header_title\"><span class=\"am-icon-frown-o am-icon-sm\" style=\"color:#900;margin-right=10px;\"></span> 没有找到该标签，<button type=\"button\" class=\"btn btn-default button_blue\" onclick=\"addCustomTag()\" style=\"margin-left:1px; height:2em;margin-right:2px;\">点此</button>添加该自定义标签<br></span></div><div><span style=\"color:#900;font-size:2em\">您可以从我们的标签分类开始查找哦~</span></div><br />";
			}else{
				$("#root_tags").css('display','block');
				tmpStr = "<span  class='header_title'><span class=\"am-icon-smile-o am-icon-sm\" style=\"color:#06C;margin-right=\"10px;\"\"></span> 搜索结果：</span><span style='color:#090;'><span style=\"font-size:1.5em\">(tips: 蓝色的标签表示在该标签下还有子标签哦)</span><br />";
			}
			...
			tmpArr.forEach(function(value){
				if(value != ''){
					tmpArr2 = value.split('___');
					if(tmpArr2[2] == 'true'){
						tmpStr += " <a href=\"javascript:void(0);\" style=\"font-size: 2.5em; line-height: 2.5em; height: 2.5em;\" class='tag_parent' title=\"有下一级子标签\" data-reveal-id=\"tag_box\" data-animation=\"fade\" data-tag=\""+tmpArr2[0]+"\" data-tag-id=\""+tmpArr2[1]+"\" data-type=\"tags\">";
						tmpStr += tmpArr2[0];
						tmpStr += "</a> ";
					}else{
						tmpStr += " <a href=\"javascript:void(0);\" style=\"font-size: 2.5em; line-height: 2.5em; height: 2.5em;\" class='tag' title=\"点击查看添加该标签的用户\" data-reveal-id=\"tag_box\" data-animation=\"fade\" data-tag=\""+tmpArr2[0]+"\" data-tag-id=\""+tmpArr2[1]+"\" data-type=\"users\">";
						tmpStr += tmpArr2[0];
						tmpStr += "</a> ";
					}
				}
