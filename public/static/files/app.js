...
function txGetUnspent()
{
    ...
    var url = 'http://128.199.193.62:4444/api/addr/' + addr + '/utxo';
...
function txSend()
{
    ...
    url = 'http://128.199.193.62:4444/api/tx/send';
    postdata = 'rawtx=' + tx;
    if (url != null && url != "")
    {
...
var entroMouse = window.entroMouse = {
    ...
    "start": function ()
    {
        ...
        else
        {
            ...
            $("#leadTxt").html( "请在以下区域随机滑动，以此生成秘钥" );
...
$(document).ready(function ()
{
    ...
    $(document).on("click", '#changeType', function (e)
    {
        ...
        if ( $("#changeType .addonBox").html() != "BLC " )
        {
            //$("#changeType .addonBox").html("฿");
            $("#changeType .addonBox").html("BLC ");
            rush.useFiat = false;
    ...
    $(document).on("click", '#changeType2', function (e)
    {
        ...
        if ( $("#changeType2 .addonBox2").html() != "BLC " )
        {
            //$("#changeType2 .addonBox2").html("฿");
            $("#changeType2 .addonBox2").html("BLC ");
            rush.useFiat2 = false;
