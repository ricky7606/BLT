			...
			tmpArr.forEach(function(value){
				if(value != ''){
					...
					if(tmpArr2[2] == 'true'){
						...
						tmpStr += " <a href=\"javascript:void(0);\" class='tag' title=\"点击查看添加该标签的发布及用户\" data-reveal-id=\"tag_box\" data-animation=\"fade\" data-tag=\""+tmpArr2[0]+"\" data-tag-id=\""+tmpArr2[1]+"\" data-type=\"users\">";
						tmpStr += tmpArr2[0];
						tmpStr += "</a> ";
					}
				}
...
function searchTags(new_page){
	...
	$.post('/index/usertags/searchTags', {tag:jQuery.trim($('#search_tags').val()),page:new_page}, function(msg) {
		if(msg == ''){
			...
			if(no_searched == '1'){
				tmpStr = "<span class=\"am-icon-frown-o\" style=\"color:#900;font-size: 0.8em; line-height:20px;\"> 没有找到您想要的标签，但您可以从我们的标签分类开始查找<br /><span style='color:#090;font-size: 0.8em;'>(tips:蓝色的标签表示在该标签下还有子标签)</span></span><br />";
			}else{
				tmpStr = "<span class=\"am-icon-smile-o\" style=\"color:#06C;font-size: 0.8em; line-height:20px;\"> 搜索结果：<span style='color:#090;font-size: 0.8em;'>(tips:蓝色的标签表示在该标签下还有子标签)</span></span><br />";
			}
