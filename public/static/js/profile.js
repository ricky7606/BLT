...
function changePassword(){
	if(isPasswordOK && isPassword2OK){
		...
		$.post('/index/userprofile/changePassword', {password:jQuery.trim($('#password').val()),new_password:jQuery.trim($('#new_password').val()),mobile:jQuery.trim($('#old_mobile').val())}, function(msg) {
			if(msg=='ok'){
