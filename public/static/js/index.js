...
document.getElementById('submitbtn').addEventListener('click', function () {
	...
	if(isContentOK){
		...
		$.post('/index/article/saveReplyArticle', {content:jQuery.trim($('#content').val()),content_text:jQuery.trim($('#content_text').val()),articleid:jQuery.trim($('#articleid').val()),replyid:jQuery.trim($('#replyid').val())}, function(msg) {
			if(msg=='ok'){
...
document.getElementById('reportbtn').addEventListener('click', function () {
	...
	if(isReportTypeOK){
		...
		$.post('/index/article/report', {articleid:jQuery.trim($('#articleid').val()),report_type:jQuery.trim($('#report_type').val()),article_type:jQuery.trim($('#article_type').val()),report_comment:jQuery.trim($('#report_comment').val())}, function(msg) {
			if(msg=='ok'){
...
function addView(articleid){
		$.post('/index/article/addView', {articleid:articleid}, function(msg) {
			return true;
		});
}
...
function follow(articleid,i){
	$.post('/index/article/follow', {articleid:articleid}, function(msg) {
		if(msg=='ok'){
...
function chkLike(articleid,i){
	$.post('/index/article/like', {articleid:articleid}, function(msg) {
...
function attUser(userid,i){
	$.post('/index/userarticles/attUser', {userid:userid}, function(msg) {
		if(msg=='ok'){
