...
class QnasReply extends Model {
	...
	public function saveReplyQna($userid, $content, $content_text, $thumb_img, $qnaid, $pendingid = ''){
		...
		$message_text = "“<a href=\"\\index\\userreplydetail?userid=".$userid."\" target=\"_blank\">".$userinfo->username."</a>”回答：“<a href=\"\\index\\qnadetails?id=".$qnaid."\" target=\"_blank\">".$qnainfo->title."</a>”。";
		$message = new Message;
